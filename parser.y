...
%token<node> ABSTRACT_KEYWORD CONTINUE_KEYWORD FOR_KEYWORD NEW_KEYWORD SWITCH_KEYWORD ASSERT_KEYWORD DEFAULT_KEYWORD IF_KEYWORD PACKAGE_KEYWORD SYNCHRONIZED_KEYWORD BOOLEAN_KEYWORD DO_KEYWORD GOTO_KEYWORD PRIVATE_KEYWORD THIS_KEYWORD BREAK_KEYWORD DOUBLE_KEYWORD IMPLEMENTS_KEYWORD PROTECTED_KEYWORD THROW_KEYWORD BYTE_KEYWORD ELSE_KEYWORD IMPORT_KEYWORD PUBLIC_KEYWORD THROWS_KEYWORD CASE_KEYWORD ENUM_KEYWORD INSTANCEOF_KEYWORD RETURN_KEYWORD TRANSIENT_KEYWORD CATCH_KEYWORD EXTENDS_KEYWORD INT_KEYWORD SHORT_KEYWORD TRY_KEYWORD CHAR_KEYWORD FINAL_KEYWORD INTERFACE_KEYWORD STATIC_KEYWORD VOID_KEYWORD CLASS_KEYWORD FINALLY_KEYWORD LONG_KEYWORD STRICTFP_KEYWORD VOLATILE_KEYWORD CONST_KEYWORD FLOAT_KEYWORD NATIVE_KEYWORD SUPER_KEYWORD WHILE_KEYWORD __KEYWORD
%token<node> EXPORTS_KEYWORD OPENS_KEYWORD REQUIRES_KEYWORD USES_KEYWORD MODULE_KEYWORD PERMITS_KEYWORD SEALED_KEYWORD VAR_KEYWORD NONSEALED_KEYWORD PROVIDES_KEYWORD TO_KEYWORD WITH_KEYWORD OPEN_KEYWORD RECORD_KEYWORD TRANSITIVE_KEYWORD YIELD_KEYWORD
%token<node> IDENTIFIERS  LITERALS  PTR_OP EQ_OP GE_OP  LE_OP  NE_OP  AND_OP  OR_OP  INC_OP  DEC_OP  LEFT_OP  RIGHT_OP  BIT_RIGHT_SHFT_OP ADD_ASSIGN  SUB_ASSIGN  MUL_ASSIGN  DIV_ASSIGN  AND_ASSIGN  OR_ASSIGN  XOR_ASSIGN  MOD_ASSIGN  LEFT_ASSIGN  RIGHT_ASSIGN  BIT_RIGHT_SHFT_ASSIGN  ELLIPSIS  DOUBLE_COLON DIAMOND
...
top_level_class_or_interface_declaration_zero_or_more
            :   /* empty */                                                                     {Node* node = createNode("top_level_class_or_interface_declaration_zero_or_more"); $$ = node;} 
...
single_type_import_declaration
            :   IMPORT_KEYWORD type_name ';' {Node* node = createNode("single type import declaration"); node.addChildren({$1,$2,$3}); $$ = node;}

type_import_on_demand_declaration
            :   IMPORT_KEYWORD type_name '.' '*' ';' module_declaration{Node* node = createNode("type import on demand declaration"); node.addChildren({$1,$2,$3,$4,$5}); $$ = node;}

single_static_import_declaration
            :   IMPORT_KEYWORD STATIC_KEYWORD type_name '.' IDENTIFIERS ';' {Node* node = createNode("single static import declaration"); node.addChildren({$1,$2,$3,$4,$5}); $$ = node;}

static_import_on_demand_declaration
            :   IMPORT_KEYWORD STATIC_KEYWORD type_name '.' '*' ';' {Node* node = createNode("static import on demand declaration"); node.addChildren({$1,$2,$3,$4,$5,$}); $$ = node;}
...
top_level_class_or_interface_declaration
            ...
            |   ';'       {Node* node = createNode("top level class or interface declaration"); node.addChildren({$1}); $$ = node;}

module_declaration
            :   OPEN_zero_or_one MODULE_KEYWORD type_name '{' '}'   {Node* node = createNode("module declaration"); node.addChildren({$1,$2,$3,$4}); $$ = node;}
            |   OPEN_zero_or_one MODULE_KEYWORD type_name '{' module_directive_one_or_more '}' {Node* node = createNode("module declaration"); node.addChildren({$1,$2,$3,$4,$5}); $$ = node;}
...
module_directive
            :   REQUIRES_KEYWORD modifiers_zero_or_more type_name ';' {Node* node = createNode("module directive"); node.addChildren({$1,$2,$3}); $$ = node;}
            |   EXPORTS_KEYWORD type_name ';'                         {Node* node = createNode("module directive"); node.addChildren({$1,$2,$3}); $$ = node;}
            |   EXPORTS_KEYWORD type_name TO_KEYWORD type_name comma_module_name_zero_or_more ';'  {Node* node = createNode("module directive"); node.addChildren({$1,$2,$3,$4,$5}); $$ = node;}
            |   OPENS_KEYWORD type_name ';' {Node* node = createNode("module directive"); node.addChildren({$1,$2,$3}); $$ = node;}
            |   OPENS_KEYWORD type_name TO_KEYWORD type_name comma_module_name_zero_or_more ';'    {Node* node = createNode("module directive"); node.addChildren({$1,$2,$3,$4,$5}); $$ = node;}
            |   USES_KEYWORD type_name ';'  {Node* node = createNode("module directive"); node.addChildren({$1,$2,$3}); $$ = node;}
            |   PROVIDES_KEYWORD type_name WITH_KEYWORD type_name comma_type_name_zero_or_more ';' {Node* node = createNode("module directive"); node.addChildren({$1,$2,$3,$4,$5}); $$ = node;}

comma_type_name_zero_or_more
            :   /* empty */  {Node* node = createNode("comma type name zero or more"); node.addChildren({}); $$ = node;}
            |   ',' type_name comma_type_name_zero_or_more {Node* node = createNode("comma type name zero or more"); node.addChildren({$1,$2}); $$ = node;}

comma_module_name_zero_or_more
            :   /* empty */ {Node* node = createNode("comma module name zero or more"); node.addChildren({}); $$ = node;}
            |   ',' type_name comma_module_name_zero_or_more {Node* node = createNode("comma module name zero or more"); node.addChildren({$1,$2}); $$ = node;}
...
primary_no_new_array
            ...
            |   type_name '.' THIS_KEYWORD {Node* node = createNode("primary no new array"); node.addChildren({$1,$2,$3}); $$ = node;}
            |   '(' expression ')' {Node* node = createNode("primary no new array"); node.addChildren({$1,$2,$3}); $$ = node;}
...
field_access
            :   primary '.' IDENTIFIERS {Node* node = createNode("field access"); node.addChildren({$1,$2,$3}); $$ = node;}
            |   SUPER_KEYWORD '.' IDENTIFIERS {Node* node = createNode("field access"); node.addChildren({$1,$2,$3}); $$ = node;}
            |   type_name '.' SUPER_KEYWORD '.' IDENTIFIERS {Node* node = createNode("field access"); node.addChildren({$1,$2,$3,$4,$5}); $$ = node;}

array_access
            :   expression_name '[' expression ']' {Node* node = createNode("array access"); node.addChildren({$1,$2,$3,$4}); $$ = node;}
            |   IDENTIFIERS  '[' expression ']' {Node* node = createNode("array access"); node.addChildren({$1,$2,$3}); $$ = node;}
            |   primary_no_new_array '[' expression ']' {Node* node = createNode("array access"); node.addChildren({$1,$2,$3,$4}); $$ = node;}
...
method_reference
            ...
            |   type_name '.' SUPER_KEYWORD DOUBLE_COLON IDENTIFIERS  {Node* node = createNode("method reference"); node.addChildren({$1,$2,$3,$4}); $$ = node;}
        ...
        //     |   array_type DOUBLE_COLON NEW_KEYWORD
            ...
            |   type_name '.' SUPER_KEYWORD DOUBLE_COLON type_arguments IDENTIFIERS {Node* node = createNode("method reference"); node.addChildren({$1,$2,$3,$4,$5,$6}); $$ = node;}
        //     |   class_type DOUBLE_COLON type_arguments NEW_KEYWORD

method_invocation
            :   IDENTIFIERS '(' argument_list_zero_or_one ')' {Node* node = createNode("method invocation"); node.addChildren({$1,$2,$3,$4}); $$ = node;}
            |   expression_name '.' IDENTIFIERS '(' argument_list_zero_or_one ')'    {Node* node = createNode("method invocation"); node.addChildren({$1,$2,$3,$4,$5,$6}); $$ = node;}         
            |   primary '.' IDENTIFIERS '(' argument_list_zero_or_one ')'       {Node* node = createNode("method invocation"); node.addChildren({$1,$2,$3,$4,$5,$6}); $$ = node;}
            |   SUPER_KEYWORD '.' IDENTIFIERS '(' argument_list_zero_or_one ')'   {Node* node = createNode("method invocation"); node.addChildren({$1,$2,$3,$4,$5,$6}); $$ = node;}
            |   expression_name '.' SUPER_KEYWORD '.' IDENTIFIERS '(' argument_list_zero_or_one ')'   {Node* node = createNode("method invocation"); node.addChildren({$1,$2,$3,$4,$5,$6,$7,$8}); $$ = node;}
            |   expression_name '.' type_arguments IDENTIFIERS '(' argument_list_zero_or_one ')'    {Node* node = createNode("method invocation"); node.addChildren({$1,$2,$3,$4,$5,$6,$7}); $$ = node;}           
            |   primary '.' type_arguments IDENTIFIERS '(' argument_list_zero_or_one ')'   {Node* node = createNode("method invocation"); node.addChildren({$1,$2,$3,$4,$5,$6,$7}); $$ = node;}           
            |   SUPER_KEYWORD '.' type_arguments IDENTIFIERS '(' argument_list_zero_or_one ')'   {Node* node = createNode("method invocation"); node.addChildren({$1,$2,$3,$4,$5,$6,$7}); $$ = node;}           
            |   expression_name '.' SUPER_KEYWORD '.' type_arguments IDENTIFIERS '(' argument_list_zero_or_one ')'   {Node* node = createNode("method invocation"); node.addChildren({$1,$2,$3,$4,$5,$6,$7,$8,$9}); $$ = node;}           
...
condtional_expression
            ...
            |   conditional_or_expression '?' expression ':' condtional_expression {Node* node = createNode("condtional expression"); node.addChildren({$1,$2,$3,$4,$5}); $$ = node;}           
            |   conditional_or_expression '?' expression ':' lambda_expression {Node* node = createNode("condtional expression"); node.addChildren({$1,$2,$3,$4,$5}); $$ = node;}           
...
inclusive_or_expression
            ...
            |   inclusive_or_expression '|' exclusive_or_expression {Node* node = createNode("inclusive or expression"); node.addChildren({$1,$2,$3}); $$ = node;}           

exclusive_or_expression
            :   and_expression {Node* node = createNode("exclusive or expression"); node.addChildren({$1}); $$ = node;}           
            |   exclusive_or_expression '^' and_expression {Node* node = createNode("exclusive or expression"); node.addChildren({$1,$2,$3}); $$ = node;}           

and_expression
            :   equality_expression {Node* node = createNode("and expression"); node.addChildren({$1}); $$ = node;}           
            |   and_expression '&' equality_expression {Node* node = createNode("and expression"); node.addChildren({$1,$2,$3}); $$ = node;}           
...
relational_expression
            ...
            |   relational_expression '<' shift_expression  {Node* node = createNode("relational expression"); node.addChildren({$1,$2,$3}); $$ = node;}           
            |   relational_expression '>' shift_expression {Node* node = createNode("relational expression"); node.addChildren({$1,$2,$3}); $$ = node;}           
...
additive_expression
            ...
            |   additive_expression '+' multiplicative_expression {Node* node = createNode("additive expression"); node.addChildren({$1,$2,$3}); $$ = node;}           
            |   additive_expression '-' multiplicative_expression {Node* node = createNode("additive expression"); node.addChildren({$1,$2,$3}); $$ = node;}           

multiplicative_expression
            :   unary_expression {Node* node = createNode("multiplicative expression"); node.addChildren({$1}); $$ = node;}           
            |   multiplicative_expression '*' unary_expression {Node* node = createNode("multiplicative expression"); node.addChildren({$1,$2,$3}); $$ = node;}           
            |   multiplicative_expression '%' unary_expression  {Node* node = createNode("multiplicative expression"); node.addChildren({$1,$2,$3}); $$ = node;}           
            |   multiplicative_expression '/' unary_expression {Node* node = createNode("multiplicative expression"); node.addChildren({$1,$2,$3}); $$ = node;}           
...
unary_expression
            ...
            |   '+' unary_expression {Node* node = createNode("unary expression"); node.addChildren({$1,$2}); $$ = node;}           
            |   '-' unary_expression {Node* node = createNode("unary expression"); node.addChildren({$1,$2}); $$ = node;}           
...
unary_expression_not_plus_minus
            ...
            |   '~' unary_expression {Node* node = createNode("unary expression not plus minus"); node.addChildren({$1,$2}); $$ = node;}           
            |   '!' unary_expression {Node* node = createNode("unary expression not plus minus"); node.addChildren({$1,$2}); $$ = node;}           
...
postfix_expression
            ...
            |   expression_name  {Node* node = createNode("postfix expression"); node.addChildren({$1}); $$ = node;}           
...
expression_name
            :   IDENTIFIERS {Node* node = createNode("expression name"); node.addChildren({$1}); $$ = node;}           
            |   expression_name  '.' IDENTIFIERS  {Node* node = createNode("expression name"); node.addChildren({$1,$2,$3}); $$ = node;}           
...
cast_expression
            :   '(' primitive_type ')' unary_expression {Node* node = createNode("cast expression"); node.addChildren({$1,$2,$3,$4}); $$ = node;}           
            |   '(' IDENTIFIERS ')' unary_expression  {Node* node = createNode("cast expression"); node.addChildren({$1,$2,$3,$4}); $$ = node;}           
            |   '(' type_name ')' unary_expression {Node* node = createNode("cast expression"); node.addChildren({$1,$2,$3,$4}); $$ = node;}           
            |   '(' IDENTIFIERS additional_bound ')' unary_expression {Node* node = createNode("cast expression"); node.addChildren({$1,$2,$3,$4,$5}); $$ = node;}           
            |   '(' type_name additional_bound ')' unary_expression {Node* node = createNode("cast expression"); node.addChildren({$1,$2,$3,$4,$5}); $$ = node;}           

switch_expression
            :   SWITCH_KEYWORD '(' expression ')' switch_block {Node* node = createNode("cswitch expression"); node.addChildren({$1,$2,$3,$4}); $$ = node;}           

switch_block
            :   '{' switch_rule switch_rule_zero_or_more '}' {Node* node = createNode("switch block"); node.addChildren({$1,$2,$3}); $$ = node;}           
            |   '{' switch_block_statement_group_zero_or_more switch_label_colon_zero_or_more '}' {Node* node = createNode("switch block"); node.addChildren({$1,$2,$3}); $$ = node;}           
...
switch_block_statement_group_zero_or_more
            :   /* empty */  {Node* node = createNode("switch block statement group zero or more"); node.addChildren({$1}); $$ = node;}           
...
switch_label_colon_zero_or_more
            ...
            |   switch_label ':' switch_label_colon_zero_or_more  {Node* node = createNode("switch label colon zero or more"); node.addChildren({$1,$2,$3}); $$ = node;}           

switch_rule
            :   switch_label PTR_OP expression ';' {Node* node = createNode("switch rule"); node.addChildren({$1,$2,$3,$4}); $$ = node;}           
...
switch_block_statement_group
            :   switch_label ':' switch_label_colon_zero_or_more block_statements {Node* node = createNode("switch block statement group"); node.addChildren({$1,$2,$3}); $$ = node;}           

switch_label
            :   CASE_KEYWORD case_constant comma_case_constant_zero_or_more  {Node* node = createNode("switch label"); node.addChildren({$1,$2}); $$ = node;}           
...
comma_case_constant_zero_or_more
            ...
            |   ',' case_constant comma_case_constant_zero_or_more {Node* node = createNode("comma case constant zero or more"); node.addChildren({$1,$2}); $$ = node;}           
...
class_instance_creation_expression
            ...
            |   type_name '.' unqualified_class_instance_creation_expression {Node* node = createNode("class instance creation expression"); node.addChildren({$1,$2,$3}); $$ = node;}           
            |   primary '.' unqualified_class_instance_creation_expression {Node* node = createNode("class instance creation expression"); node.addChildren({$1,$2,$3}); $$ = node;}           

unqualified_class_instance_creation_expression
            :   NEW_KEYWORD IDENTIFIERS '(' argument_list_zero_or_one ')' class_body_zero_or_one {Node* node = createNode("unqualified class instance creation expression"); node.addChildren({$1,$2,$3,$4,$5,$6}); $$ = node;}           
            |   NEW_KEYWORD type_arguments IDENTIFIERS '(' argument_list_zero_or_one ')' class_body_zero_or_one  {Node* node = createNode("unqualified class instance creation expression"); node.addChildren({$1,$2,$3,$4,$5,$6,$7}); $$ = node;}           
            |   NEW_KEYWORD class_or_interface_type_to_instantiate '(' argument_list_zero_or_one ')' class_body_zero_or_one {Node* node = createNode("unqualified class instance creation expression"); node.addChildren({$1,$2,$3,$4,$5,$6,$7}); $$ = node;}           
            |   NEW_KEYWORD type_arguments class_or_interface_type_to_instantiate '(' argument_list_zero_or_one ')' class_body_zero_or_one {Node* node = createNode("unqualified class instance creation expression"); node.addChildren({$1,$2,$3,$4,$5,$6}); $$ = node;}           
...
argument_list 
            :   expression comma_expression_zero_or_more {Node* node = createNode("argument list"); node.addChildren({$1}); $$ = node;}           

comma_expression_zero_or_more
            :   /* empty */  {Node* node = createNode("comma expression zero or more"); node.addChildren({}); $$ = node;}           
            |   ',' expression comma_expression_zero_or_more {Node* node = createNode("comma expression zero or more"); node.addChildren({$1,$2,$3}); $$ = node;}           

class_or_interface_type_to_instantiate
            :   IDENTIFIERS DIAMOND  {Node* node = createNode("class or interface type to instantiate"); node.addChildren({$1,$2,$3}); $$ = node;}           
            |   IDENTIFIERS type_arguments {Node* node = createNode("class or interface type to instantiate"); node.addChildren({$1,$2,$3}); $$ = node;}           

assignment
            :   expression_name assignment_operators expression    {Node* node = createNode("assignment"); node.addChildren({$1,$2,$3}); $$ = node;}           
...
assignment_operators 
            :   '=' {Node* node = createNode("assignment_operators"); node.addChildren({$1}); $$ = node;}           
            |   ADD_ASSIGN  {Node* node = createNode("assignment_operators"); node.addChildren({$1}); $$ = node;}           
            |   SUB_ASSIGN   {Node* node = createNode("assignment_operators"); node.addChildren({$1}); $$ = node;}           
            |   MUL_ASSIGN   {Node* node = createNode("assignment_operators"); node.addChildren({$1}); $$ = node;}           
            |   DIV_ASSIGN {Node* node = createNode("assignment_operators"); node.addChildren({$1}); $$ = node;}           
            |   AND_ASSIGN {Node* node = createNode("assignment_operators"); node.addChildren({$1}); $$ = node;}           
            |   OR_ASSIGN {Node* node = createNode("assignment_operators"); node.addChildren({$1}); $$ = node;}           
            |   XOR_ASSIGN {Node* node = createNode("assignment_operators"); node.addChildren({$1}); $$ = node;}           
            |   MOD_ASSIGN {Node* node = createNode("assignment_operators"); node.addChildren({$1}); $$ = node;}           
            |   LEFT_ASSIGN {Node* node = createNode("assignment_operators"); node.addChildren({$1}); $$ = node;}           
            |   RIGHT_ASSIGN  {Node* node = createNode("assignment_operators"); node.addChildren({$1}); $$ = node;}           
            |   BIT_RIGHT_SHFT_ASSIGN {Node* node = createNode("assignment_operators"); node.addChildren({$1}); $$ = node;}           

array_creation_expression
            :   NEW_KEYWORD primitive_type dim_expr dim_exprs dims_zero_or_one {Node* node = createNode("array creation expression"); node.addChildren({$1,$2,$3,$4}); $$ = node;}           
...
dim_exprs
            :   /* empty */ {Node* node = createNode("dims exprs"); node.addChildren({}); $$ = node;}           
            |   dim_exprs dim_expr {Node* node = createNode("dims exprs"); node.addChildren({$1}); $$ = node;}           

dim_expr    
            :  '[' expression ']' {Node* node = createNode("dims expr"); node.addChildren({$1,$2,$3}); $$ = node;}

dims 
            :   '[' ']'         {Node* node = createNode("dims"); node.addChildren({$1,$2}); $$ = node;}
            |   '[' ']' dims     {Node* node = createNode("dims"); node.addChildren({$1,$2,$3}); $$ = node;} 
...
array_initializer
            :   '{' variable_initializer_list_zero_or_more commas_zero_or_more '}' {Node* node = createNode("array initializer"); node.addChildren({$1,$2,$3}); $$ = node;}
...
commas_zero_or_more
            ...
            |   ',' commas_zero_or_more {Node* node = createNode("commas zero or more"); node.addChildren({$1,$2}); $$ = node;}

variable_initializer_list
            :   variable_initializer  {Node* node = createNode("variable initializer list"); node.addChildren({$1}); $$ = node;}
            |   variable_initializer ',' variable_initializer_list {Node* node = createNode("variable initializer list"); node.addChildren({$1,$2,$3}); $$ = node;}
...
lambda_expression
            ...
            |   IDENTIFIERS PTR_OP block {Node* node = createNode("lambda expression"); node.addChildren({$1,$2}); $$ = node;}

lambda_parameters
            :   '(' lambda_parameter_list_zero_or_one ')' {Node* node = createNode("lambda parameters"); node.addChildren({$1,$2,$3}); $$ = node;}
...
comma_identifiers_zero_or_more
            ...
            |   ',' IDENTIFIERS comma_identifiers_zero_or_more {Node* node = createNode("comma identifiers zero or more"); node.addChildren({$1,$2,$3}); $$ = node;}

comma_lambda_parameter_zero_or_more
            :   /* empty */  {Node* node = createNode("comma lambda parameter zero or more"); node.addChildren({}); $$ = node;}
            |   ',' lambda_parameter comma_lambda_parameter_zero_or_more {Node* node = createNode("comma lambda parameter zero or more"); node.addChildren({$1,$2,$3}); $$ = node;}

lambda_parameter
            :   lambda_parameter_type variable_declarator_id {Node* node = createNode("lambda parameter"); node.addChildren({$1,$2}); $$ = node;}
            |   variable_modifier_one_or_more lambda_parameter_type variable_declarator_id {Node* node = createNode("lambda parameter"); node.addChildren({$1,$2}); $$ = node;}
            |   variable_arity_parameter {Node* node = createNode("lambda parameter"); node.addChildren({$1}); $$ = node;}

lambda_parameter_type
            :   unann_type {Node* node = createNode("lambda parameter type"); node.addChildren({$1,$2}); $$ = node;}
            |   VAR_KEYWORD {Node* node = createNode("lambda parameter type"); node.addChildren({$1,$2}); $$ = node;}
...
class_literal
            :   type_name '.' CLASS_KEYWORD {Node* node = createNode("class literal"); node.addChildren({$1,$2,$3}); $$ = node;}
            |   numeric_type '.' CLASS_KEYWORD {Node* node = createNode("class literal"); node.addChildren({$1,$2,$3}); $$ = node;}
            |   BOOLEAN_KEYWORD '.' CLASS_KEYWORD {Node* node = createNode("class literal"); node.addChildren({$1,$2,$3}); $$ = node;}
            |   VOID_KEYWORD '.' CLASS_KEYWORD {Node* node = createNode("class literal"); node.addChildren({$1,$2,$3}); $$ = node;}
            |   type_name empty_array_one_or_more '.' CLASS_KEYWORD {Node* node = createNode("class literal"); node.addChildren({$1,$2,$3}); $$ = node;}
            |   numeric_type empty_array_one_or_more '.' CLASS_KEYWORD {Node* node = createNode("class literal"); node.addChildren({$1,$2,$3}); $$ = node;}
            |   BOOLEAN_KEYWORD empty_array_one_or_more '.' CLASS_KEYWORD {Node* node = createNode("class literal"); node.addChildren({$1,$2,$3}); $$ = node;}
            |   VOID_KEYWORD empty_array_one_or_more '.' CLASS_KEYWORD {Node* node = createNode("class literal"); node.addChildren({$1,$2,$3}); $$ = node;}

empty_array_one_or_more
            :   '[' ']' {Node* node = createNode("empty array one or more"); node.addChildren({$1,$2}); $$ = node;}
            |   '[' ']' empty_array_one_or_more {Node* node = createNode("empty array one or more"); node.addChildren({$1,$2,$3}); $$ = node;}

type_name
            :   IDENTIFIERS {Node* node = createNode("type name"); node.addChildren({$1}); $$ = node;}
            |   type_name '.' IDENTIFIERS {Node* node = createNode("type name"); node.addChildren({$1,$2,$3}); $$ = node;}
...
normal_interface_declaration
            :   modifiers_zero_or_more INTERFACE_KEYWORD IDENTIFIERS interface_extends_zero_or_one interface_permits_zero_or_one interface_body {Node* node = createNode("normal interface declaration"); node.addChildren({$1,$2,$3,$4,$5}); $$ = node;}
            |   modifiers_zero_or_more INTERFACE_KEYWORD IDENTIFIERS type_parameters interface_extends_zero_or_one interface_permits_zero_or_one interface_body {Node* node = createNode("normal interface declaration"); node.addChildren({$1,$2,$3,$4,$5}); $$ = node;}
...
additional_bound
            :   '&' class_type {Node* node = createNode("additional bound"); node.addChildren({$1,$2}); $$ = node;}
...
class_type
            ...
            |   class_type '.' IDENTIFIERS {Node* node = createNode("class type"); node.addChildren({$1,$2,$3}); $$ = node;}
            |   type_name '.' IDENTIFIERS type_arguments {Node* node = createNode("class type"); node.addChildren({$1,$2,$3}); $$ = node;}
            |   class_type '.' IDENTIFIERS type_arguments {Node* node = createNode("class type"); node.addChildren({$1,$2,$3}); $$ = node;}

type_arguments
            :   '<' type_argument_list '>' {Node* node = createNode("type arguments"); node.addChildren({$1,$2,$3}); $$ = node;}

type_argument_list
            :   type_argument comma_type_arguement_zero_or_more {Node* node = createNode("type argument list"); node.addChildren({$1,$2}); $$ = node;}
            |   primitive_type dims comma_type_arguement_zero_or_more {Node* node = createNode("type argument list"); node.addChildren({$1,$2}); $$ = node;}

comma_type_arguement_zero_or_more
            :   /* empty */  {Node* node = createNode("comma type arguement zero or more"); node.addChildren({}); $$ = node;}
            |   ',' type_argument comma_type_arguement_zero_or_more {Node* node = createNode("comma type arguement zero or more"); node.addChildren({$1,$2,$3}); $$ = node;}
            |   ',' primitive_type dims comma_type_arguement_zero_or_more {Node* node = createNode("comma type arguement zero or more"); node.addChildren({$1,$2,$3}); $$ = node;}
...
wild_card
            :   '?' {Node* node = createNode("wild card"); node.addChildren({$1}); $$ = node;}
            |   '?' EXTENDS_KEYWORD reference_type {Node* node = createNode("wild card"); node.addChildren({$1,$2,$3}); $$ = node;}
            |   '?' EXTENDS_KEYWORD primitive_type dims {Node* node = createNode("wild card"); node.addChildren({$1,$2,$3}); $$ = node;}
            |   '?' SUPER_KEYWORD reference_type  {Node* node = createNode("wild card"); node.addChildren({$1,$2,$3}); $$ = node;}
            |   '?' SUPER_KEYWORD primitive_type dims {Node* node = createNode("wild card"); node.addChildren({$1,$2,$3}); $$ = node;}
...
array_type
            :   class_type dims {Node* node = createNode("array type"); node.addChildren({$1}); $$ = node;}
...
interface_body
            :   '{' interface_member_decleration_zero_or_more '}' {Node* node = createNode("interface body"); node.addChildren({$1,$2,$3}); $$ = node;}
...
constant_declaration
            :   modifiers_zero_or_more unann_type variable_declarator_list ';' {Node* node = createNode("constant decleration"); node.addChildren({$1,$2,$3}); $$ = node;}

interface_method_declaration
            :   modifiers_zero_or_more method_header block {Node* node = createNode("constant decleration"); node.addChildren({$1,$2}); $$ = node;}
            |   modifiers_zero_or_more method_header ';' {Node* node = createNode("constant decleration"); node.addChildren({$1,$2}); $$ = node;}

//  ########   BLOCKS, STATEMENTS AND PATTERNS   ########  

block
        :   '{' block_statements_zero_or_one '}' {Node* node = createNode("block"); node.addChildren({$1,$2,$3}); $$ = node;}
...
local_variable_declaration_statement
        :   local_variable_declaration ';' {Node* node = createNode("local variable declaration statemen"); node.addChildren({$1,$2}); $$ = node;}
...
do_statememt
        :   DO_KEYWORD statement WHILE_KEYWORD '(' expression ')' ';' {Node* node = createNode("do statement"); node.addChildren({$1,$2,$3,$4,$5,$6,$7}); $$ = node;}

empty_statement
        :   ';'   {Node* node = createNode("empty statement"); node.addChildren({$1}); $$ = node;}

labeled_statement
        :   IDENTIFIERS ':' statement {Node* node = createNode("labeled statement"); node.addChildren({$1,$2,$3}); $$ = node;}

labeled_statement_no_short_if
        :   IDENTIFIERS ':' statement_no_short_if {Node* node = createNode("labeled statement no short if"); node.addChildren({$1,$2,$3}); $$ = node;}

expression_statement
        :  statement_expression ';'  {Node* node = createNode("expression statement"); node.addChildren({$1,$2}); $$ = node;}
...
if_then_statement
        :  IF_KEYWORD '(' expression ')' statement {Node* node = createNode("if then statement"); node.addChildren({$1,$2,$3,$4,$5}); $$ = node;}

if_then_else_statement
        :  IF_KEYWORD  '(' expression ')' statement_no_short_if ELSE_KEYWORD statement {Node* node = createNode("if then else statement"); node.addChildren({$1,$2,$3,$4,$5,$6,$7}); $$ = node;}

if_then_else_statement_no_short_if
        :  IF_KEYWORD  '(' expression ')' statement_no_short_if ELSE_KEYWORD statement_no_short_if {Node* node = createNode("if then else statement no short if"); node.addChildren({$1,$2,$3,$4,$5,$6,$7,$8}); $$ = node;}

assert_statement
        :  ASSERT_KEYWORD expression ';'  {Node* node = createNode("assert statement"); node.addChildren({$1,$2,$3}); $$ = node;}
        |  ASSERT_KEYWORD expression ':' expression ';' {Node* node = createNode("assert statement"); node.addChildren({$1,$2,$3,$4,$5}); $$ = node;}

while_statement
        :  WHILE_KEYWORD '(' expression ')' statement   {Node* node = createNode("while statement"); node.addChildren({$1,$2,$3,$4,$5}); $$ = node;}

while_statement_no_short_if
        :  WHILE_KEYWORD '(' expression ')' statement_no_short_if {Node* node = createNode("while statement no short if"); node.addChildren({$1,$2,$3,$4,$5}); $$ = node;}
...
basic_for_statement
        :  FOR_KEYWORD '(' for_init_zero_or_one ';' expression_zero_or_one ';' for_update_zero_or_one ')' statement {Node* node = createNode("basic for statement"); node.addChildren({$1,$2,$3,$4,$5,$6,$7,$8,$9}); $$ = node;}

basic_for_statement_no_short_if
        :  FOR_KEYWORD '(' for_init_zero_or_one ';' expression_zero_or_one ';' for_update_zero_or_one ')' statement_no_short_if {Node* node = createNode("basic for statement no short if"); node.addChildren({$1,$2,$3,$4,$5,$6,$7,$8,$9}); $$ = node;}
...
comma_statement_expression_zero_or_more
        :  /* empty */ 
        |  ',' statement_expression comma_statement_expression_zero_or_more {Node* node = createNode("comma statement expression zero or more"); node.addChildren({$1,$2}); $$ = node;}

enhanced_for_statement
        :  FOR_KEYWORD '(' local_variable_declaration ':' expression ')' statement {Node* node = createNode("enhanced for statement"); node.addChildren({$1,$2,$3,$4,$5,$6,$7}); $$ = node;}

enhanced_for_statement_no_short_if
        :  FOR_KEYWORD '(' local_variable_declaration ':' expression ')' statement_no_short_if {Node* node = createNode("enhanced for statement no short if"); node.addChildren({$1,$2,$3,$4,$5,$6,$7}); $$ = node;}

break_statement
        :  BREAK_KEYWORD IDENTIFIERS ';' {Node* node = createNode("break statement"); node.addChildren({$1,$2}); $$ = node;}
        |  BREAK_KEYWORD ';'  {Node* node = createNode("break statement"); node.addChildren({$1,$2}); $$ = node;}

yield_statement
        :  YIELD_KEYWORD expression ';'  {Node* node = createNode("yield statement"); node.addChildren({$1,$2}); $$ = node;}

continue_statement
        :  CONTINUE_KEYWORD identifier_zero_or_one ';' {Node* node = createNode("continue statement"); node.addChildren({$1,$2,$3}); $$ = node;}
...
return_statement
        :  RETURN_KEYWORD expression_zero_or_one ';' {Node* node = createNode("return statement"); node.addChildren({$1,$2,$3}); $$ = node;}

throw_statement
        :  THROW_KEYWORD expression ';' {Node* node = createNode("throw statement"); node.addChildren({$1,$2,$3}); $$ = node;}

synchronized_statement
        :  SYNCHRONIZED_KEYWORD '(' expression ')' block {Node* node = createNode("synchronized statement"); node.addChildren({$1,$2,$3,$4,$5}); $$ = node;}

try_statement
        :  TRY_KEYWORD block catches {Node* node = createNode("try statement"); node.addChildren({$1,$2,$3}); $$ = node;}
        |  TRY_KEYWORD block catches_zero_or_one finally {Node* node = createNode("try statement"); node.addChildren({$1,$2,$3}); $$ = node;}
...
catch_clause
        : CATCH_KEYWORD '(' catch_formal_parameter ')' block  {Node* node = createNode("catch clause"); node.addChildren({$1,$2,$3,$4,$5}); $$ = node;}

catch_formal_parameter
        :   catch_type variable_declarator_id {Node* node = createNode("catch formal parameter"); node.addChildren({$1,$2}); $$ = node;}
        |   variable_modifier_one_or_more catch_type variable_declarator_id {Node* node = createNode("catch formal parameter"); node.addChildren({$1,$2}); $$ = node;}
...
slash_class_type_zero_or_more
        ...
        |   '|' class_type slash_class_type_zero_or_more {Node* node = createNode("slash class type zero or more"); node.addChildren({$1,$2,$3}); $$ = node;}

finally
        : FINALLY_KEYWORD block {Node* node = createNode("finally"); node.addChildren({$1,$2}); $$ = node;}

try_with_resources_statement
        :  TRY_KEYWORD resources_specification block catches_zero_or_one finally_zero_or_one {Node* node = createNode("try with resources statement"); node.addChildren({$1,$2,$3,$4}); $$ = node;}
...
resources_specification
        :  '(' resource_list semicolon_zero_or_one ')' {Node* node = createNode("resources specification"); node.addChildren({$1,$2,$3}); $$ = node;}

semicolon_zero_or_one
        :   /* empty */   {Node* node = createNode("semicolon zero  or one"); node.addChildren({}); $$ = node;}
        |   ';' {Node* node = createNode("semicolon zero  or one"); node.addChildren({$1}); $$ = node;}
...
semicolon_resource_zero_or_more
        :   /* empty */ 
        |   ';' resource semicolon_resource_zero_or_more  {Node* node = createNode("semicolon resource zero or more"); node.addChildren({$1,$2,$3}); $$ = node;}
...
type_parameters
        :  '<' type_parameter_list '>' {Node* node = createNode("type parameters"); node.addChildren({$1,$2,$3}); $$ = node;}
...
comma_type_parameter_zero_or_more
        ...
        |  ',' IDENTIFIERS comma_type_parameter_zero_or_more {Node* node = createNode("comma type parameter zero or more"); node.addChildren({$1,$2,$3}); $$ = node;}
        |  ',' IDENTIFIERS type_bound comma_type_parameter_zero_or_more {Node* node = createNode("comma type parameter zero or more"); node.addChildren({$1,$2,$3,$4}); $$ = node;}
...
comma_interface_type_zero_or_more
        ...
        |  ',' class_type comma_interface_type_zero_or_more  {Node* node = createNode("comma interface type zero or more"); node.addChildren({$1,$2,$3}); $$ = node;}

class_permits
        :  PERMITS_KEYWORD type_name comma_type_name_zero_or_more {Node* node = createNode("class permits"); node.addChildren({$1,$2,$3}); $$ = node;}

class_body
        :  '{' class_body_declaration_zero_or_more '}' {Node* node = createNode("class body"); node.addChildren({$1,$2,$3}); $$ = node;}
...
class_member_declaration
        ...
        |  ';' {Node* node = createNode("class member declaration"); node.addChildren({$1}); $$ = node;}

field_declaration
        :  modifiers_zero_or_more unann_type variable_declarator_list ';' {Node* node = createNode("field declaration"); node.addChildren({$1,$2,$3}); $$ = node;}
...
comma_variable_declarator_zero_or_more
        ...
        |  comma_variable_declarator_zero_or_more ',' variable_declarator  {Node* node = createNode("comma variable declarator zero or more"); node.addChildren({$1,$2,$3}); $$ = node;}
...
equals_variable_initializer_zero_or_one
        ...
        |  '=' expression  {Node* node = createNode("equals variable initializer zero or one"); node.addChildren({$1,$2}); $$ = node;}
        |  '=' array_initializer {Node* node = createNode("equals variable initializer zero or one"); node.addChildren({$1,$2}); $$ = node;}
...
unann_class_type
        ...
        |  unann_class_type '.' IDENTIFIERS {Node* node = createNode("unann class type"); node.addChildren({$1,$2,$3}); $$ = node;}

method_declaration
        :  modifiers_zero_or_more method_header block {Node* node = createNode("method declaration"); node.addChildren({$1,$2,$3}); $$ = node;}
        |  modifiers_zero_or_more method_header ';' {Node* node = createNode("method declaration"); node.addChildren({$1,$2,$3}); $$ = node;}
...
method_declarator
        :  IDENTIFIERS '(' formal_parameter_list_zero_or_one ')' dims_zero_or_one {Node* node = createNode("method declarator"); node.addChildren({$1,$2,$3,$4,$5}); $$ = node;}
        |  IDENTIFIERS '(' reciever_parameter ',' formal_parameter_list_zero_or_one ')' dims_zero_or_one {Node* node = createNode("method declarator"); node.addChildren({$1,$2,$3,$4,$5,$6,$7}); $$ = node;}
...
identifier_dot_zero_or_one
        ...
        |  IDENTIFIERS '.'  {Node* node = createNode("identifier dot zero or one"); node.addChildren({$1,$2}); $$ = node;}

formal_parameter_list
        :  formal_parameter {Node* node = createNode("formal parameter list"); node.addChildren({$1}); $$ = node;}
        |  formal_parameter ',' formal_parameter_list {Node* node = createNode("formal parameter list"); node.addChildren({$1,$2,$3}); $$ = node;}
...
comma_exception_type_zero_or_more
        ...
        |  ',' class_type comma_exception_type_zero_or_more     {Node* node = createNode("comma exception type zero or more"); node.addChildren({$1,$2,$3}); $$ = node;}
...
constructor_declarator
        :  IDENTIFIERS '(' formal_parameter_list_zero_or_one ')'  {Node* node = createNode("constructor declarator"); node.addChildren({$1,$2,$3,$4}); $$ = node;}
        |  IDENTIFIERS '(' reciever_parameter ',' formal_parameter_list_zero_or_one ')' {Node* node = createNode("constructor declarator"); node.addChildren({$1,$2,$3,$4,$5,$6}); $$ = node;}
        |  type_parameters IDENTIFIERS '(' formal_parameter_list_zero_or_one ')' {Node* node = createNode("constructor declarator"); node.addChildren({$1,$2,$3,$4,$5}); $$ = node;}
        |  type_parameters IDENTIFIERS '(' reciever_parameter ',' formal_parameter_list_zero_or_one ')' {Node* node = createNode("constructor declarator"); node.addChildren({$1,$2,$3,$4,$5,$6,$7}); $$ = node;}

constructor_body
        :  '{' explicit_constructor_invocation '}'  {Node* node = createNode("constructor body"); node.addChildren({$1,$2,$3}); $$ = node;}
        |  '{' block_statements '}'  {Node* node = createNode("constructor body"); node.addChildren({$1,$2,$3}); $$ = node;}
        |  '{' explicit_constructor_invocation block_statements '}'  {Node* node = createNode("constructor body"); node.addChildren({$1,$2,$3}); $$ = node;}
        |  '{' '}' {Node* node = createNode("constructor body"); node.addChildren({$1,$2}); $$ = node;}

explicit_constructor_invocation
        :  THIS_KEYWORD '(' argument_list_zero_or_one ')' ';' {Node* node = createNode("explicit constructor invocation"); node.addChildren({$1,$2,$3,$4,$5}); $$ = node;}
        |  SUPER_KEYWORD '(' argument_list_zero_or_one ')' ';' {Node* node = createNode("explicit constructor invocation"); node.addChildren({$1,$2,$3,$4,$5}); $$ = node;}
        |  expression_name '.' SUPER_KEYWORD '(' argument_list_zero_or_one ')' ';' {Node* node = createNode("explicit constructor invocation"); node.addChildren({$1,$2,$3,$4,$5,$6,$7}); $$ = node;}
        |  primary '.' SUPER_KEYWORD '(' argument_list_zero_or_one ')' ';' {Node* node = createNode("explicit constructor invocation"); node.addChildren({$1,$2,$3,$4,$5,$6,$7}); $$ = node;}
        |  type_arguments THIS_KEYWORD '(' argument_list_zero_or_one ')' ';' {Node* node = createNode("explicit constructor invocation"); node.addChildren({$1,$2,$3,$4,$5,$6}); $$ = node;}
        |  type_arguments SUPER_KEYWORD '(' argument_list_zero_or_one ')' ';' {Node* node = createNode("explicit constructor invocation"); node.addChildren({$1,$2,$3,$4,$5,$6}); $$ = node;}
        |  expression_name '.' type_arguments SUPER_KEYWORD '(' argument_list_zero_or_one ')' ';' {Node* node = createNode("explicit constructor invocation"); node.addChildren({$1,$2,$3,$4,$5,$6,$7,$8}); $$ = node;}
        |  primary '.' type_arguments SUPER_KEYWORD '(' argument_list_zero_or_one ')' ';' {Node* node = createNode("explicit constructor invocation"); node.addChildren({$1,$2,$3,$4,$5,$6,$7,$8}); $$ = node;}
